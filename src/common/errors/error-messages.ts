export const ERROR_MESSAGE = {
  ...
  AUTH_INVALID_CREDENTIALS: 'Las credenciales ingresadas no son válidas.',
  ...
  PET_ROLE_FORBIDDEN:
    'Tu rol no permite realizar esta acción sobre la mascota.',
  ...
  VACCINATION_NOT_FOUND:
    'No se encontró la vacunación solicitada para esta mascota.',
